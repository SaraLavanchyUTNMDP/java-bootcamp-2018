package com.bootcampglobant.userregister.repository;
...
public interface UserRepository extends JpaRepository<User,Integer> {
	...
	public void update(@Param("name") String name, @Param("username") String username,
			@Param("password") String password, @Param("email") String email, @Param("birthDate") String date);
